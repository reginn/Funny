...
public class EntityTrinityBoat extends Entity
{
	/**
	...
	public EntityTrinityBoat(World par1World)
	{
		super(par1World);
	...
	public EntityTrinityBoat(World par1World, double par2, double par4, double par6)
	{
		this(par1World);
	...
	public boolean attackEntityFrom(DamageSource par1DamageSource, float par2)
	{
		...
		else if (!this.worldObj.isRemote && !this.isDead)
		{
			...
			if (flag || this.getDamageTaken() > 40.0F)
			{
				...
				if (!flag)
				{
					this.func_145778_a(TrinityCore.itemTrinityBoat, 1, 0.0F);
				}
			...
			if (!this.worldObj.isRemote)
			{
				...
				if (list != null && !list.isEmpty())
				{
					for (int k1 = 0; k1 < list.size(); ++k1)
					{
						...
						if (entity != this.riddenByEntity && entity.canBePushed() && (entity instanceof EntityBoat || entity instanceof EntityTrinityBoat))
						{
